 ...
 * file:../oriz-family dependency of @chirag127/oriz-ui v2.0.0) and can't be
 * resolved via the GitHub tarball install. Until oriz-family ships to npm,
 * every site keeps its own byte-identical copy.
 *
